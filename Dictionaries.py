...
capitals = {'USA': 'Washington DC',
            ...
            'China': 'Beijing',
            'Russia': 'Moscow'}
# this adds newvalues in our dictionary since it is changed
capitals.update({'Germany': 'Berlin'})
# this updates an existing key.value in the dictionary
...
shutil.copyfile('Dictionaries.py',
                'C:\\Users\\User\\Desktop\\folder python\\Dictionaries.py')
